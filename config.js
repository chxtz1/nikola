...
const CONFIG = {
    ...
    valentineName: "Nikola",

    // The title that appears in the browser tab
    // You can use emojis! 💝 💖 💗 💓 💞 💕
    pageTitle: "Zostaniesz moją walentynką? :3 💝",
    ...
    colors: {
        backgroundStart: "#3f2e56",      // Gradient start (try pastel colors for a soft look)
        backgroundEnd: "#401f3e",        // Gradient end (should complement backgroundStart)
    ...
    music: {
        ...
        musicUrl: "https://res.cloudinary.com/dn1ynpbr3/video/upload/v1739387659/ijvuge2kqhdpvi8efq4x.mp3", // Music streaming URL
